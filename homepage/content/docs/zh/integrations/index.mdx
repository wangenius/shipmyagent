...
通过集成 GitHub、Slack、Discord 和自定义 webhook 等外部服务来扩展 ShipMyAgent。
...
- [Telegram](/docs/integrations/telegram) - 聊天和通知
- [飞书机器人](/docs/integrations/feishu) - 群聊/私聊对话与通知
- [QQ 机器人](/docs/integrations/qq) - 群聊/私聊对话与通知
- [GitHub](#github) - PR 自动化和 issue 管理
- [Slack](#slack) - 团队通知
- [Discord](#discord) - 社区参与
...
也可以把启动参数写进 `ship.json` 的 `start` 字段，然后直接运行 `shipmyagent .` / `shipmyagent start`：
...
1. 转到 https://discord.com/developers/applications
2. 创建"新应用程序"
3. 转到"Bot"部分 → 创建 Bot
4. 复制 **Token**
