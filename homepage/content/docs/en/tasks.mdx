...
> ⚠️ **Simplified mode (2026-02-03)**: the current `shipmyagent` package temporarily disables **Tasks/Runs/Scheduler**. This page documents the older/planned task system and does not reflect current runtime behavior.
...
1. Read `.ship/logs/<YYYY-MM-DD>.jsonl`
2. Count error types
3. Identify patterns
...
❌ Bad: Monolithic task that does everything
