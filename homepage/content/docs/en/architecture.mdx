...
- When more detail is needed, the model can call `chat_load_history` to load and inject earlier messages from `.ship/chat/<chatKey>/conversations/history.jsonl`
