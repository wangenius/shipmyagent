...
- [Telegram](/docs/services/telegram) - Chat and notifications
- [GitHub](#github) - PR automation and issue management
- [Slack](#slack) - Team notifications
- [Webhook](#webhook) - Custom services

---

## Telegram

See the dedicated guide: [Telegram service](/docs/services/telegram).
...
Generic webhook support for custom services.
...
# Test Slack
shipmyagent test --service slack
...
```bash
# Check service usage
shipmyagent stats --services

# Audit service access
shipmyagent audit --services
```
...
- [Configuration](/docs/configuration) - Service setup details
- [Tasks](/docs/tasks) - Automate with services
