...
Configure service adapters for various platforms to deploy your Agent on different chat platforms:
...
- **groupAccess**: (Optional) Group chat access control, `"initiator_or_admin"` (default) or `"anyone"`
