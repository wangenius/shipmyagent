 ...
 * - 运行时 built-in roots 是基于 `paths.js` 的 `import.meta.url` 解析出来的 `bin/core/skills/built-in`
 */
...
const srcRoot = path.join(packageRoot, "src", "core", "skills", "built-in");
const dstRoot = path.join(packageRoot, "bin", "core", "skills", "built-in");
