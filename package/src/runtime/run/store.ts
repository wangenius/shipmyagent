...
import { generateId, getRunsDirPath, getTimestamp } from "../../utils.js";
import type { RunRecord, RunTrigger } from "./types.js";
...
export async function listRuns(
  ...
  const statuses =
    Array.isArray(opts?.statuses) && opts!.statuses.length > 0 ? new Set(opts!.statuses) : null;
