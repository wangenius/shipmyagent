...
export function renderClaudeSkillsPromptSection(
  ...
  lines.push("- Use `skills_list` to discover available skills");
  lines.push("- Use `skills_load` to activate a skill by name or id");
  ...
  lines.push("2. If a skill defines `allowedTools`, you can ONLY use those tools (plus chat_send)");
