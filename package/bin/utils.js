...
`;
export const DEFAULT_SHIP_JSON = {
    name: 'shipmyagent',
    version: '1.0.0',
    llm: {
        provider: 'anthropic',
...
export function getAgentMdPath(cwd) {
    return path.join(cwd, 'Agent.md');
}
export function getShipJsonPath(cwd) {
    return path.join(cwd, 'ship.json');
}
export function getShipDirPath(cwd) {
    return path.join(cwd, '.ship');
}
export function getTasksDirPath(cwd) {
    return path.join(cwd, '.ship', 'tasks');
}
export function getRoutesDirPath(cwd) {
    return path.join(cwd, '.ship', 'routes');
}
export function getApprovalsDirPath(cwd) {
    return path.join(cwd, '.ship', 'approvals');
}
export function getLogsDirPath(cwd) {
    return path.join(cwd, '.ship', 'logs');
}
export function getCacheDirPath(cwd) {
